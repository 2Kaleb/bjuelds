  ...
  wayland.windowManager = {
    wayfire = {
      ...
      settings = {
        ...
        core = {
          plugins = "alpha animate autostart command cube expo fast-switcher foreign-toplevel grid gtk-shell idle invert move oswitch preserve-output place resize scale session-lock shortcuts-inhibit simple-tile switcher vswipe vswitch wayfire-shell window-rules wm-actions wobbly wrot zoom";
        ...
        window-rules = {
          Dorion = ''on created if title contains "Dorion" start_on_output "HDMI-A-1"'';
        };
      };
    };
  };
