...

{
  ...
  fileSystems."/srv/media" = {
    ...
    fsType = "btrfs";
    options = [ "subvol=media" "compress=zstd:3" ];
  };
  swapDevices = [{
      ...
      serverConfig = {
        ...
        Preferences = {
          WebUI = {
            Username = "kdebre";
            Password_PBKDF2 =
              "@ByteArray(yCZAo0jXz+3gnkVdIkO/nw==:uIeS1ydnstl6iuGZpBbXiT8t+huhmnGfQoO3vqmIpaN3uez2Ct9ZQt5DUG97zhes20rZUQP5/pPHBVKUoTBcsA==)";
          };
        };
      };
    };
