{ pkgs, lib, pkgs-unstable, ... }: {
  ...
  services = {
    ...
    gotify = {
      enable = true;
      environment = { GOTIFY_SERVER_PORT = 8001; };
    };
    plausible = {
      enable = false;
    ...
    caddy = {
      ...
      virtualHosts."tierlist.kalebdebre.de".extraConfig = ''
        ...
        file_server
      '';
      virtualHosts."trilium.kalebdebre.de".extraConfig = ''
        reverse_proxy localhost:8394
      '';
      ...
      '';
      virtualHosts."seer.kalebdebre.de".extraConfig = ''
        reverse_proxy htpc:5055
      '';
      virtualHosts."sabnzbd.kalebdebre.de".extraConfig = ''
        reverse_proxy htpc:8080
      '';
      virtualHosts."qbittorrent.kalebdebre.de".extraConfig = ''
        reverse_proxy htpc:8088
      '';
      ...
      '';
      virtualHosts."paperless.kalebdebre.de".extraConfig = ''
        reverse_proxy htpc:28981
      '';
    };
  };
